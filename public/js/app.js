...
var App = function() {
	...
	var uiBlocksApi = function($block, $mode) {
		...
		if ($mode === 'init') {
			...
			if ($elBlock.length) {
				...
				//$('#high-column2').highcharts().setSize(null, undefined);
				//$('#high-bars').highcharts().setSize(600, 300);
				// Mode selection
				switch($mode) {
	...
	var uiHelperDatepicker = function(){
		...
		jQuery('.js-datepicker-inicio').datepicker({
			weekStart: 1,
			autoclose: true,
			todayHighlight: true,
			language:'es'
			...
			if(typeof selected.date !== "undefined") {
				...
				var dpinicioDate3 = new Date(selected.date.valueOf());
				jQuery('.js-datepicker-fin').datepicker('setStartDate', dpinicioDate1);
				dpinicioDate2.setMonth(dpinicioDate2.getMonth() + 12);
				jQuery('.js-datepicker-fin').datepicker('setEndDate', dpinicioDate2);
				jQuery('.js-datepicker-fin').datepicker('setDate', dpinicioDate3);
			}
		});

		jQuery('.js-datepicker-inicio-6').datepicker({
			weekStart: 1,
			autoclose: true,
			todayHighlight: true,
			language:'es'
			...
			if(typeof selected.date !== "undefined") {
				...
				var dpinicioDate3 = new Date(selected.date.valueOf());
				jQuery('.js-datepicker-fin').datepicker('setStartDate', dpinicioDate1);
				dpinicioDate2.setMonth(dpinicioDate2.getMonth() + 6);
				jQuery('.js-datepicker-fin').datepicker('setEndDate', dpinicioDate2);
				jQuery('.js-datepicker-fin').datepicker('setDate', dpinicioDate3);
			}
		});

		jQuery('.js-datepicker-fin').datepicker({
			weekStart: 1,
			autoclose: true,
			todayHighlight: true,
			language:'es'
